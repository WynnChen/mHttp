...
Class Client implements Countable
{
	...
	private const CURLE_MSG = [
		...
		CURLE_FTP_QUOTE_ERROR => 'FTP_QUOTE_ERROR', CURLE_HTTP_NOT_FOUND => 'HTTP_NOT_FOUND',
		CURLE_WRITE_ERROR => 'WRITE_ERROR',
		CURLE_MALFORMAT_USER => 'MALFORMAT_USER',
		CURLE_FTP_COULDNT_STOR_FILE => 'FTP_COULDNT_STOR_FILE',
		CURLE_READ_ERROR => 'READ_ERROR', CURLE_OUT_OF_MEMORY => 'OUT_OF_MEMORY',
	...
	private array $options = [
		CURLOPT_USERAGENT => 'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:84.0) Gecko/20100101 Firefox/84.0',
